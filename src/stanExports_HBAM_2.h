...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_HBAM_2");
    reader.add_event(129, 127, "end", "model_HBAM_2");
    return reader;
}
#include <stan_meta_header.hpp>
class model_HBAM_2
  : public stan::model::model_base_crtp<model_HBAM_2> {
private:
        int N;
        int J;
        int N_obs;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            Vi = std::vector<int>(N, int(0));
            stan::math::fill(Vi, std::numeric_limits<int>::min());
            // execute transformed data statements
            current_statement_begin__ = 21;
            for (int i = 1; i <= N; ++i) {
                current_statement_begin__ = 22;
                if (as_bool(logical_lt(get_base1(V, i, "V", 1), 0))) {
                    current_statement_begin__ = 23;
                    stan::model::assign(Vi, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                ((get_base1(V, i, "V", 1) + B) + 1), 
                                "assigning variable Vi");
                } else {
            ...
            validate_non_negative_index("alpha_mean", "(B * 2)", (B * 2));
            num_params_r__ += (B * 2);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("alpha_mean", "(B * 2)", (B * 2));
        context__.validate_dims("parameter initialization", "alpha_mean", "vector_d", context__.to_vec((B * 2)));
        Eigen::Matrix<double, Eigen::Dynamic, 1> alpha_mean((B * 2));
        size_t alpha_mean_j_1_max__ = (B * 2);
        for (size_t j_1__ = 0; j_1__ < alpha_mean_j_1_max__; ++j_1__) {
            alpha_mean(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_unconstrain(alpha_mean);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 32;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> alpha_mean;
            (void) alpha_mean;  // dummy to suppress unused var warning
            if (jacobian__)
                alpha_mean = in__.vector_constrain((B * 2), lp__);
            else
                alpha_mean = in__.vector_constrain((B * 2));
            current_statement_begin__ = 33;
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                if (as_bool(logical_neq(get_base1(V, i, "V", 1), 0))) {
                    ...
                    stan::model::assign(alpha0, 
                                ...
                                ((get_base1(alpha_raw, i, 1, "alpha_raw", 1) * sigma_alpha) + get_base1(alpha_mean, get_base1(Vi, i, "Vi", 1), "alpha_mean", 1)), 
                    ...
                    stan::model::assign(alpha0, 
                                ...
                                ((get_base1(alpha_raw, i, 2, "alpha_raw", 1) * sigma_alpha) + get_base1(alpha_mean, get_base1(Vi, i, "Vi", 1), "alpha_mean", 1)), 
                                "assigning variable alpha0");
                } else {
                    current_statement_begin__ = 68;
                    stan::model::assign(alpha0, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list())), 
                                (get_base1(alpha_raw, i, 1, "alpha_raw", 1) * sigma_alpha), 
                                "assigning variable alpha0");
                    current_statement_begin__ = 69;
                    stan::model::assign(alpha0, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_uni(2), stan::model::nil_index_list())), 
                                (get_base1(alpha_raw, i, 2, "alpha_raw", 1) * sigma_alpha), 
                                "assigning variable alpha0");
                }
            }
            ...
            for (int n = 1; n <= N_obs; ++n) {
                ...
                stan::model::assign(log_lik, 
                            ...
                            log_mix(get_base1(lambda, get_base1(ii, n, "ii", 1), "lambda", 1), normal_log(get_base1(Y, n, "Y", 1), (get_base1(alpha0, get_base1(ii, n, "ii", 1), 1, "alpha0", 1) + (get_base1(beta0, get_base1(ii, n, "ii", 1), 1, "beta0", 1) * get_base1(theta, get_base1(jj, n, "jj", 1), "theta", 1))), (stan::math::sqrt(get_base1(eta, get_base1(ii, n, "ii", 1), "eta", 1)) * get_base1(rho, get_base1(jj, n, "jj", 1), "rho", 1))), normal_log(get_base1(Y, n, "Y", 1), (get_base1(alpha0, get_base1(ii, n, "ii", 1), 2, "alpha0", 1) + (get_base1(beta0, get_base1(ii, n, "ii", 1), 2, "beta0", 1) * get_base1(theta, get_base1(jj, n, "jj", 1), "theta", 1))), (stan::math::sqrt(get_base1(eta, get_base1(ii, n, "ii", 1), "eta", 1)) * get_base1(rho, get_base1(jj, n, "jj", 1), "rho", 1)))), 
            ...
            lp_accum__.add(normal_log<propto__>(alpha_mean, 0, (B / 2.0)));
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> alpha_mean = in__.vector_constrain((B * 2));
        size_t alpha_mean_j_1_max__ = (B * 2);
        for (size_t j_1__ = 0; j_1__ < alpha_mean_j_1_max__; ++j_1__) {
            vars__.push_back(alpha_mean(j_1__));
        }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_1__ = 0; j_1__ < alpha_mean_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "alpha_mean" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        size_t beta_raw_j_2_max__ = 2;
        size_t beta_raw_j_1_max__ = N;
...
typedef model_HBAM_2_namespace::model_HBAM_2 stan_model;
#ifndef USING_R
