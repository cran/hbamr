...
static constexpr std::array<const char*, 77> locations_array__ =
  ...
  " (in 'HBAM_MINI', line 21, column 2 to column 25)",
  " (in 'HBAM_MINI', line 22, column 2 to column 24)",
  " (in 'HBAM_MINI', line 23, column 2 to column 22)",
  " (in 'HBAM_MINI', line 24, column 2 to column 26)",
  " (in 'HBAM_MINI', line 25, column 2 to column 30)",
  " (in 'HBAM_MINI', line 26, column 2 to column 40)",
  " (in 'HBAM_MINI', line 27, column 2 to column 22)",
  " (in 'HBAM_MINI', line 28, column 2 to column 22)",
  " (in 'HBAM_MINI', line 29, column 2 to column 22)",
  " (in 'HBAM_MINI', line 32, column 2 to column 22)",
  " (in 'HBAM_MINI', line 33, column 2 to column 22)",
  " (in 'HBAM_MINI', line 34, column 2 to column 21)",
  " (in 'HBAM_MINI', line 35, column 2 to column 24)",
  " (in 'HBAM_MINI', line 36, column 2 to column 74)",
  " (in 'HBAM_MINI', line 68, column 2 to column 53)",
  " (in 'HBAM_MINI', line 69, column 2 to column 74)",
  " (in 'HBAM_MINI', line 70, column 2 to column 71)",
  " (in 'HBAM_MINI', line 71, column 2 to column 85)",
  ...
  " (in 'HBAM_MINI', line 62, column 2 to line 65, column 42)",
  ...
  " (in 'HBAM_MINI', line 10, column 32 to column 37)",
  " (in 'HBAM_MINI', line 10, column 2 to column 41)",
  ...
  " (in 'HBAM_MINI', line 13, column 31 to column 36)",
  " (in 'HBAM_MINI', line 13, column 2 to column 46)",
  " (in 'HBAM_MINI', line 16, column 2 to column 64)",
  " (in 'HBAM_MINI', line 17, column 2 to column 55)",
  " (in 'HBAM_MINI', line 18, column 31 to column 36)",
  " (in 'HBAM_MINI', line 18, column 2 to column 64)",
  " (in 'HBAM_MINI', line 21, column 9 to column 10)",
  " (in 'HBAM_MINI', line 22, column 9 to column 10)",
  " (in 'HBAM_MINI', line 24, column 8 to column 9)",
  " (in 'HBAM_MINI', line 28, column 9 to column 10)",
  " (in 'HBAM_MINI', line 32, column 8 to column 9)",
  ...
  " (in 'HBAM_MINI', line 68, column 9 to column 10)",
  " (in 'HBAM_MINI', line 69, column 9 to column 10)",
...
public:
  ~model_HBAM_MINI() {}
  model_HBAM_MINI(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_HBAM_MINI_namespace::model_HBAM_MINI";
    // suppress unused var warning
    (void) function__;
    ...
    num_params_r__ = (N * 2) + (N * 2) + 2 + J + 1 + 1 + 1 + N + 1;
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_HBAM_MINI_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
          ...
          stan::math::log_mix(
            ...
            stan::math::normal_lpdf<false>(
              ...
              stan::model::rvalue(theta, "theta",
                stan::model::index_uni(
                  stan::model::rvalue(jj, "jj", stan::model::index_uni(n)))))),
              tau)), "assigning variable log_lik", stan::model::index_uni(n));
      }
      current_statement__ = 14;
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_HBAM_MINI_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"alpha_raw\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(N) + ",\"cols\":" + std::to_string(2) + "},\"block\":\"parameters\"},{\"name\":\"beta_raw\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(N) + ",\"cols\":" + std::to_string(2) + "},\"block\":\"parameters\"},{\"name\":\"theta_lr\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(2) + "},\"block\":\"parameters\"},{\"name\":\"theta_raw\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(J) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"sigma_alpha\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma_beta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"tau\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"lambda_raw\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"parameters\"},{\"name\":\"psi\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"theta\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(J) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"alpha0\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(N) + ",\"cols\":" + std::to_string(2) + "},\"block\":\"transformed_parameters\"},{\"name\":\"beta0\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(N) + ",\"cols\":" + std::to_string(2) + "},\"block\":\"transformed_parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N_obs) + "},\"block\":\"transformed_parameters\"},{\"name\":\"lambda\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"kappa\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"},{\"name\":\"alpha\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"},{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"},{\"name\":\"chi\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"}]");
  }
