...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_HBAM_R_MINI");
    reader.add_event(114, 112, "end", "model_HBAM_R_MINI");
    return reader;
}
#include <stan_meta_header.hpp>
class model_HBAM_R_MINI
  : public stan::model::model_base_crtp<model_HBAM_R_MINI> {
private:
        int N;
        int J;
        int N_obs;
...
typedef model_HBAM_R_MINI_namespace::model_HBAM_R_MINI stan_model;
#ifndef USING_R
