...
stanmodels <- c("BAM", "FBAM_MINI", "FBAM_MULTI", "FBAM_MULTI_NF", "HBAM", "HBAM_MAX", "HBAM_MINI", "HBAM_MULTI", "HBAM_MULTI_NF", "HBAM_NF", "HBAM_R_MINI")
...
Rcpp::loadModule("stan_fit4HBAM_MAX_mod", what = TRUE)
