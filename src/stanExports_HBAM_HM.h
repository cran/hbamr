...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_HBAM_HM");
    reader.add_event(99, 97, "end", "model_HBAM_HM");
    return reader;
}
#include <stan_meta_header.hpp>
class model_HBAM_HM
  : public stan::model::model_base_crtp<model_HBAM_HM> {
private:
        int N;
        int J;
        int N_obs;
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::model::assign(log_lik_V, 
                            ...
                            log_mix(get_base1(lambda, i, "lambda", 1), normal_log(get_base1(V, i, "V", 1), (get_base1(alpha0, i, 1, "alpha0", 1) + (get_base1(beta0, i, 1, "beta0", 1) * get_base1(chi0, i, 1, "chi0", 1))), tau), normal_log(get_base1(V, i, "V", 1), (get_base1(alpha0, i, 2, "alpha0", 1) + (get_base1(beta0, i, 2, "beta0", 1) * get_base1(chi0, i, 2, "chi0", 1))), tau)), 
...
typedef model_HBAM_HM_namespace::model_HBAM_HM stan_model;
#ifndef USING_R
