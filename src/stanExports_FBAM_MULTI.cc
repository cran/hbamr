...
#include "stanExports_FBAM_MULTI.h"

RCPP_MODULE(stan_fit4FBAM_MULTI_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_FBAM_MULTI")
