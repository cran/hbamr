...
namespace model_FBAM_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 87> locations_array__ =
  {" (found before start of program)",
  " (in 'FBAM', line 26, column 2 to column 25)",
  " (in 'FBAM', line 27, column 2 to column 24)",
  " (in 'FBAM', line 28, column 2 to column 22)",
  " (in 'FBAM', line 29, column 2 to column 26)",
  " (in 'FBAM', line 30, column 2 to column 27)",
  " (in 'FBAM', line 31, column 2 to column 17)",
  " (in 'FBAM', line 32, column 2 to column 23)",
  " (in 'FBAM', line 35, column 2 to column 22)",
  " (in 'FBAM', line 36, column 2 to column 22)",
  " (in 'FBAM', line 37, column 2 to column 21)",
  " (in 'FBAM', line 38, column 2 to column 24)",
  " (in 'FBAM', line 39, column 2 to column 75)",
  " (in 'FBAM', line 71, column 2 to column 18)",
  " (in 'FBAM', line 72, column 2 to column 16)",
  " (in 'FBAM', line 73, column 2 to column 37)",
  " (in 'FBAM', line 78, column 2 to column 74)",
  " (in 'FBAM', line 79, column 2 to column 71)",
  " (in 'FBAM', line 40, column 2 to column 20)",
  " (in 'FBAM', line 41, column 2 to column 25)",
  " (in 'FBAM', line 42, column 2 to column 25)",
  " (in 'FBAM', line 43, column 2 to column 45)",
  " (in 'FBAM', line 44, column 2 to column 45)",
  " (in 'FBAM', line 45, column 2 to column 47)",
  " (in 'FBAM', line 46, column 2 to column 48)",
  " (in 'FBAM', line 48, column 4 to line 52, column 41)",
  " (in 'FBAM', line 47, column 21 to line 53, column 3)",
  " (in 'FBAM', line 47, column 2 to line 53, column 3)",
  " (in 'FBAM', line 77, column 4 to column 37)",
  " (in 'FBAM', line 75, column 4 to column 45)",
  " (in 'FBAM', line 74, column 2 to line 77, column 37)",
  " (in 'FBAM', line 83, column 4 to column 30)",
  " (in 'FBAM', line 81, column 4 to column 78)",
  " (in 'FBAM', line 80, column 2 to line 83, column 30)",
  " (in 'FBAM', line 56, column 2 to column 33)",
  " (in 'FBAM', line 57, column 2 to column 32)",
  " (in 'FBAM', line 58, column 2 to column 32)",
  " (in 'FBAM', line 59, column 2 to column 32)",
  " (in 'FBAM', line 60, column 2 to column 31)",
  " (in 'FBAM', line 61, column 2 to column 31)",
  " (in 'FBAM', line 62, column 2 to column 45)",
  " (in 'FBAM', line 63, column 2 to column 37)",
  " (in 'FBAM', line 64, column 2 to column 28)",
  " (in 'FBAM', line 68, column 4 to column 42)",
  " (in 'FBAM', line 66, column 4 to column 27)",
  " (in 'FBAM', line 65, column 2 to line 68, column 42)",
  " (in 'FBAM', line 2, column 2 to column 19)",
  " (in 'FBAM', line 3, column 2 to column 19)",
  " (in 'FBAM', line 4, column 2 to column 23)",
  " (in 'FBAM', line 5, column 8 to column 13)",
  " (in 'FBAM', line 5, column 2 to column 33)",
  " (in 'FBAM', line 6, column 8 to column 13)",
  " (in 'FBAM', line 6, column 2 to column 33)",
  " (in 'FBAM', line 7, column 2 to column 19)",
  " (in 'FBAM', line 8, column 2 to column 30)",
  " (in 'FBAM', line 9, column 2 to column 30)",
  " (in 'FBAM', line 10, column 32 to column 37)",
  " (in 'FBAM', line 10, column 2 to column 41)",
  " (in 'FBAM', line 11, column 32 to column 33)",
  " (in 'FBAM', line 11, column 2 to column 37)",
  " (in 'FBAM', line 12, column 2 to column 31)",
  " (in 'FBAM', line 13, column 31 to column 36)",
  " (in 'FBAM', line 13, column 2 to column 46)",
  " (in 'FBAM', line 14, column 2 to column 30)",
  " (in 'FBAM', line 15, column 2 to column 29)",
  " (in 'FBAM', line 16, column 2 to column 33)",
  " (in 'FBAM', line 19, column 2 to column 14)",
  " (in 'FBAM', line 20, column 2 to column 21)",
  " (in 'FBAM', line 21, column 2 to column 27)",
  " (in 'FBAM', line 22, column 2 to column 15)",
  " (in 'FBAM', line 23, column 31 to column 36)",
  " (in 'FBAM', line 23, column 2 to column 64)",
  " (in 'FBAM', line 26, column 9 to column 10)",
  " (in 'FBAM', line 27, column 9 to column 10)",
  " (in 'FBAM', line 29, column 8 to column 9)",
  " (in 'FBAM', line 30, column 20 to column 21)",
  " (in 'FBAM', line 31, column 10 to column 11)",
  " (in 'FBAM', line 32, column 9 to column 10)",
  " (in 'FBAM', line 35, column 8 to column 9)",
  " (in 'FBAM', line 36, column 9 to column 10)",
  " (in 'FBAM', line 37, column 9 to column 10)",
  " (in 'FBAM', line 38, column 9 to column 14)",
  " (in 'FBAM', line 39, column 31 to column 32)",
  " (in 'FBAM', line 71, column 9 to column 10)",
  " (in 'FBAM', line 72, column 9 to column 10)",
  " (in 'FBAM', line 78, column 9 to column 10)",
  " (in 'FBAM', line 79, column 9 to column 10)"};
#include <stan_meta_header.hpp>
class model_FBAM final : public model_base_crtp<model_FBAM> {
private:
  int N;
  int J;
  int N_obs;
...
public:
  ~model_FBAM() {}
  model_FBAM(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_FBAM_namespace::model_FBAM";
    // suppress unused var warning
    (void) function__;
    ...
    num_params_r__ = (N * 2) + (N * 2) + 2 + J + N + (J - 1) + N;
  }
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_FBAM_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"alpha_raw", "beta_raw", "theta_lr",
                "theta_raw", "eta", "rho", "lambda_raw"};
    if (emit_transformed_parameters__) {
      std::vector<std::string>
        temp{"theta", "alpha0", "beta0", "log_lik", "lambda"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"alpha_raw\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(N) + ",\"cols\":" + std::to_string(2) + "},\"block\":\"parameters\"},{\"name\":\"beta_raw\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(N) + ",\"cols\":" + std::to_string(2) + "},\"block\":\"parameters\"},{\"name\":\"theta_lr\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(2) + "},\"block\":\"parameters\"},{\"name\":\"theta_raw\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(J) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"eta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"parameters\"},{\"name\":\"rho\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(J) + "},\"block\":\"parameters\"},{\"name\":\"lambda_raw\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"parameters\"},{\"name\":\"theta\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(J) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"alpha0\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(N) + ",\"cols\":" + std::to_string(2) + "},\"block\":\"transformed_parameters\"},{\"name\":\"beta0\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(N) + ",\"cols\":" + std::to_string(2) + "},\"block\":\"transformed_parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N_obs) + "},\"block\":\"transformed_parameters\"},{\"name\":\"lambda\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"kappa\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"},{\"name\":\"chi\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"},{\"name\":\"min_rho\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"alpha\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"},{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"}]");
  }
  inline std::string get_unconstrained_sizedtypes() const {
    return std::string("[{\"name\":\"alpha_raw\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(N) + ",\"cols\":" + std::to_string(2) + "},\"block\":\"parameters\"},{\"name\":\"beta_raw\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(N) + ",\"cols\":" + std::to_string(2) + "},\"block\":\"parameters\"},{\"name\":\"theta_lr\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(2) + "},\"block\":\"parameters\"},{\"name\":\"theta_raw\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(J) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"eta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"parameters\"},{\"name\":\"rho\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string((J -1)) + "},\"block\":\"parameters\"},{\"name\":\"lambda_raw\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"parameters\"},{\"name\":\"theta\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(J) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"alpha0\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(N) + ",\"cols\":" + std::to_string(2) + "},\"block\":\"transformed_parameters\"},{\"name\":\"beta0\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(N) + ",\"cols\":" + std::to_string(2) + "},\"block\":\"transformed_parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N_obs) + "},\"block\":\"transformed_parameters\"},{\"name\":\"lambda\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"kappa\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"},{\"name\":\"chi\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"},{\"name\":\"min_rho\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"alpha\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"},{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = (((((((N * 2) + (N * 2)) + 2) + J) + N) + J)
      + N);
...
using stan_model = model_FBAM_namespace::model_FBAM;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_FBAM_namespace::profiles__;
}
#endif
#endif
