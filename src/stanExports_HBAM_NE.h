...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_HBAM_NE");
    reader.add_event(98, 96, "end", "model_HBAM_NE");
    return reader;
}
#include <stan_meta_header.hpp>
class model_HBAM_NE
  : public stan::model::model_base_crtp<model_HBAM_NE> {
private:
        int N;
        int J;
        int N_obs;
...
typedef model_HBAM_NE_namespace::model_HBAM_NE stan_model;
#ifndef USING_R
