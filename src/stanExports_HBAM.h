...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_HBAM");
    reader.add_event(111, 109, "end", "model_HBAM");
    return reader;
}
#include <stan_meta_header.hpp>
class model_HBAM
  : public stan::model::model_base_crtp<model_HBAM> {
private:
        int N;
        int J;
        int N_obs;
...
typedef model_HBAM_namespace::model_HBAM stan_model;
#ifndef USING_R
