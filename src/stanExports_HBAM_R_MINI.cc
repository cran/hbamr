...
#include "stanExports_HBAM_R_MINI.h"

RCPP_MODULE(stan_fit4HBAM_R_MINI_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_HBAM_R_MINI")
